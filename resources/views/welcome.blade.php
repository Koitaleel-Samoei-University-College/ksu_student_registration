...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body >
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-200  py-3 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <a href="https://drive.google.com/file/d/1mVW5Bsl0y9tI4js_1eDbsteRLbm4ilXC/view?usp=sharing" class="btn btn-success btn-sm mt-2 mb-3" ><i class="bi bi-file-earmark-pdf-fill"></i> Admission Day Checklist</a>
